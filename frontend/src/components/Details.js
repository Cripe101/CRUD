...
const Details = () => {
  ...
  return (
    <div className="py-10">
      ...
      {error && <div>{error}</div>}
      {anime && (
        <div className="flex flex-col justify-end w-[500px] mx-auto bg-[#eff7f6] pt-2 py-5 px-7 rounded-xl overflow-hidden text-[#000] hover:border-[#e0fbfc] shadow-md">
          ...
          <span className="flex flex-col gap-5">
            <section className="flex gap-5 items-end ">
              <img
                src={anime.src}
                alt="Img"
                className="w-[200px] h-[300px] object-cover drop-shadow-xl rounded-lg"
              />
